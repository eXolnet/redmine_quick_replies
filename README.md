...
[![Build Status](https://img.shields.io/github/workflow/status/eXolnet/redmine_quick_replies/tests?label=tests&style=flat-square)]
(https://github.com/eXolnet/redmine_quick_replies/actions?query=workflow%3Atests)
